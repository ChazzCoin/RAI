...
class BaseFunctionIndustry(aiTextFunctions):
    def type(self):
        return "no_args"
...
class BaseFunctionSports(aiTextFunctions):
    def type(self):
        return "no_args"
...
class BaseFunctionMedical(aiTextFunctions):
    def type(self):
        return "no_args"
...
class BaseFunctionLaw(aiTextFunctions):
    def type(self):
        return "no_args"
...
class BaseFunctionSentiment(aiTextFunctions):
    def type(self):
        return "no_args"
...
class BaseFunctionDocumentContent(aiTextFunctions):
...
@register_functions("agent-plans")
class BaseFunctionAgentPlan(aiTextFunctions):
...
class BaseFunctionTopicSports(aiTextFunctions):
    def type(self): return "no_args"
...
class BaseFunctionTopicMedical(aiTextFunctions):
    def type(self): return "no_args"
    def functions(self) -> dict: return {
        "tryout_registration": f"User Prompt Context Involves tryouts, placements, registration or how to signup and get involved in the club.",
    }
...
class BaseFunctionTopicLaw(aiTextFunctions):
    def type(self): return "no_args"
    def functions(self) -> dict: return {
        "tryout_registration": f"User Prompt Context Involves tryouts, placements, registration or how to signup and get involved in the club.",
    }
...
class BaseFunctionObjective(aiTextFunctions):
    def type(self): return "no_args"
    def functions(self) -> dict: return {
...
if __name__ == "__main__":
    print(aiTextFunctions.function("categorize_sports", sub=True))