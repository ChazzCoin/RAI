...
from rai.raigents.base.BaseImageAgents.BaseImageFormats import RaiBaseImageFormats
from rai.raigents.base.BaseImageAgents.BaseImageFunctions import RaiBaseImageFunctions
from rai.raigents.base.BaseImageAgents.BaseImagePrompts import RaiBaseImagePrompts
...
class AgentQRExtractor(RaiBaseImageAgent):
    def type(self):
        return "extract"
...
class AgentVisualQueryGenerator(RaiBaseImageAgent):
    def type(self):
...
class AgentImageMetadataExtractor(RaiBaseImageAgent):
    def type(self):
...
class AgentVisualSentimentAnalyzer(RaiBaseImageAgent):
    def type(self):
