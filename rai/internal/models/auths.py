...
from rai.internal.models.users import UserModel, UsersTable
...
class AuthsTable:
    ...
    def insert_new_auth(
        ...
        """
        try:
            self.client.cursor.tool(insert_auth_query, (auth.id, auth.email, auth.password, auth.active))
    ...
    def update_user_password_by_id(self, id: str, new_password: str) -> bool:
        ...
        try:
            self.client.cursor.tool(query, (new_password, id))
            self.client.connection.commit()
    ...
    def update_email_by_id(self, id: str, email: str) -> bool:
        ...
        try:
            self.client.cursor.tool(query, (email, id))
            self.client.connection.commit()
            return self.client.cursor.rowcount == 1
        except Exception as e:
