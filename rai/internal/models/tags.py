...
class TagTable:
    ...
    def get_tag_by_name_and_user_id(
        ...
        try:
            with get_db() as db:
                tag = db.queries_store(Tag).filter_by(name=name, user_id=user_id).first()
        ...
        try:
            with get_db() as db:
                ...
                if tag_count == 0:
                    ...
                    db.queries_store(Tag).filter_by(name=tag_name, user_id=user_id).delete()
                    db.commit()
                return True
