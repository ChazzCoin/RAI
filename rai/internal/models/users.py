...
class UsersTable:
    ...
    def insert_new_user(
        ...
        try:
            self.client.cursor.tool(insert_query)
            self.client.connection.commit()
    ...
    def get_user_by_api_key(self, api_key: str) -> Optional[UserModel]:
        try:
            ...
            self.client.cursor.tool(query, (api_key,))
            row = self.client.cursor.fetchone()
            return row_to_usermodel(row)
        except Exception as e:
    ...
    def get_user_by_email(self, email: str) -> Optional[UserModel]:
        try:
            ...
            self.client.cursor.tool(query, (email,))
            row = self.client.cursor.fetchone()
            return row_to_usermodel(row)
        except Exception as e:
    ...
    def get_user_by_oauth_sub(self, sub: str) -> Optional[UserModel]:
        try:
            ...
            self.client.cursor.tool(query, (sub,))
            row = self.client.cursor.fetchone()
            return row_to_usermodel(row)
        except Exception as e:
    ...
    def update_user_role_by_id(self, id: str, role: str) -> Optional[UserModel]:
        try:
            ...
            self.client.cursor.tool(query, (role, id))
            self.client.connection.commit()
    ...
    def update_user_profile_image_url_by_id(self, id: str, profile_image_url: str) -> Optional[UserModel]:
        try:
            ...
            self.client.cursor.tool(query, (profile_image_url, id))
            self.client.connection.commit()
            return self.get_user_by_id(id)
        except Exception as e:
    ...
    def update_user_last_active_by_id(self, id: str) -> Optional[UserModel]:
        try:
            ...
            self.client.cursor.tool(query, (now, id))
            self.client.connection.commit()
            return self.get_user_by_id(id)
        except Exception as e:
    ...
    def update_user_oauth_sub_by_id(self, id: str, oauth_sub: str) -> Optional[UserModel]:
        try:
            ...
            self.client.cursor.tool(query, (oauth_sub, id))
            self.client.connection.commit()
            return self.get_user_by_id(id)
        except Exception as e:
    ...
    def update_user_by_id(self, id: str, updated: dict) -> Optional[UserModel]:
        ...
        try:
            self.client.cursor.tool(query, values)
            self.client.connection.commit()
            return self.get_user_by_id(id)
        except Exception as e:
    ...
    def update_user_api_key_by_id(self, id: str, api_key: str) -> bool:
        try:
            ...
            self.client.cursor.tool(query, (api_key, id))
            self.client.connection.commit()
