...
DEFAULT_CHROMA_SERVER_HOST = PersistentConfig(
    "DEFAULT_CHROMA_SERVER_HOST",
    "oauth.chroma.server_host",
    os.environ.get("DEFAULT_CHROMA_SERVER_HOST", "localhost"),
)

DEFAULT_CHROMA_SERVER_PORT = PersistentConfig(
    "DEFAULT_CHROMA_SERVER_PORT",
    "oauth.chroma.server_port",
...
RAG_EMBEDDING_FUNCTION = PersistentConfig(
    ...
    "rag.embedding_function",
    os.environ.get("RAG_EMBEDDING_FUNCTION", ""),
)
...
DEFAULT_OLLAMA_EMBEDDING_MODEL = PersistentConfig(
    "DEFAULT_OLLAMA_EMBEDDING_MODEL",
    "rag.DEFAULT_OLLAMA_EMBEDDING_MODEL",
    os.getenv("DEFAULT_OLLAMA_EMBEDDING_MODEL", "DEFAULT_OLLAMA_EMBEDDING_MODEL"),
)
...
WHISPER_MODEL = os.getenv("WHISPER_MODEL", "raigents/base")
