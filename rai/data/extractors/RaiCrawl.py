...
from rai.data.extractors.RaiWebDriver import RaiWebDriver

def base_url_extractor(url):
    return urlparse(url).netloc

""" Master """
class RaiCrawler(RaiWebDriver):
    base = ""

    def __init__(self, base_url: str, output_dir: str = 'output'):
        super(RaiCrawler, self).__init__()
...
if __name__ == '__main__':
    RaiCrawler(base_url='https://academy.veo.co', output_dir='output').crawl()